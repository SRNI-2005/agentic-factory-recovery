...
- Specs were AMENDED 2026-08-23 (multi-resource disruptions: machine/worker/material) and 2026-08-24 (materials/receipts reservoir + three-layer check + criteria 21/22; P3 back-edges: SUSPEND_JOB catalog entry, compile/solve back-edges to P2 §9.1 tardiness weights; workers default 8) and 2026-08-25 (time-phased MATERIAL_SHORTFALL warnings restore §4.3 DEFER reachability). Amendment markers in the spec files are normative.
